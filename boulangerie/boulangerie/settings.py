...
SECRET_KEY = 'django-insecure-3z4c0^k-xx35^brkyfai924x86a-9lrl0o(idzhm3)rl@0)=!='
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'recettes', 'templates', 'static'), # Ajoutez cette ligne
]
